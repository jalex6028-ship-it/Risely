/**
 * Database Seed Script for Risely Gamification Platform
 *
 * This script populates the Supabase database with sample data for:
 * - Quests
 * - Challenges
 * - Daily Tasks
 * - Events
...
async function seedDatabase() {
  ...
  try {
    ...
    if (challengeError) {
      console.error('❌ Error seeding challenges:', challengeError);
    } else {
    ...
    if (dailyTaskError) {
      console.error('❌ Error seeding daily tasks:', dailyTaskError);
    } else {
      console.log(`✅ Successfully seeded ${DAILY_TASKS.length} daily tasks\n`);
    }
    ...
    if (pollError) {
      console.error('❌ Error seeding polls:', pollError);
    } else {
    ...
    console.log(`   ✅ ${DAILY_TASKS.length} Daily Tasks`);
    console.log(`   ✅ ${EVENTS.length} Events`);
    console.log(`   ✅ ${REWARDS.length} Rewards`);
    console.log(`   ✅ ${POLLS.length} Polls`);
    console.log('\nYou can now log in and see all the gamification data!');
